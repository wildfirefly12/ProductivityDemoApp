...
const EditNotesCategory = (props) => {
    ...
    const saveCategory = () => {
        ...
        axios.post("api/NoteCategories/Edit", category, props.config)
            .then(response => {
    ...
    return (
        <div className={"edit-notes-category-container"}>
            <div className={"edit-notes-category-header-container"}>
                <Typography sx={{
            ...
            <div className={"edit-notes-category-form-container"}>
...
export default EditNotesCategory